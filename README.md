...
| `vault set NAME [--host H]... [--inject MODE] [--username USER]` | Encrypt and store. Prints name + last-4. Hosts, inject mode (hosted vocabulary), and username drive `http_request` |
