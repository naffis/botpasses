...
Shorter follow-ups once MCP is connected.

### First API only

MCP is already connected. The agent runs setup for one API and gives you Collect and Connect links.
