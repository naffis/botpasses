...
We think an honest "grant-vault" is more useful to you than a false "zero-knowledge". The decision is recorded in [ADR 0003](https://github.com/naffis/botpasses/blob/dev/docs/adr/0003-grant-vault-trust-model.md) and the full table of who sees what is on the [Security](/security) page.
